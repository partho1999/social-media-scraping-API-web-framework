    ...
    def fun():
        ...
        try:
            ...
            if request.method == "POST":
                ...
                # url1='http://103.96.106.250:5000/username/'+username
                # res = HttpResponseRedirect(url1)

                url ='http://103.96.106.250:5000/facebook_posts/' +username+'/'+title
                print(url)
    ...
    def fun():
        try:
            ...
            if request.method == "POST":
                ...
                url ='http://103.96.106.250:5000/twitter/' +username+'/'+title
                #return HttpResponseRedirect(url)
                # df = Twitter(title)
                # url = df.to_html()
                print(url)
    ...
    def fun():
        try:
            ...
            if request.method == "POST":
                ...
                url ='http://103.96.106.250:5000/youtube/' +username+'/'+title
                #return HttpResponseRedirect(url)
                print(url)
                return render(request,'result.html', { 'url' : url })
    ...
    def fun():
        try:
            ...
            if request.method == "POST":
                ...
                url ='http://103.96.106.250:5000/google/'+username+'/'+title
                #return HttpResponseRedirect(url)
                print(url)
...
def google_download(request):
    url = 'http://103.96.106.250:5000/google/download'
    return HttpResponseRedirect(url)
...
def download(request):
    ...
    for file in filtered_lst:
        ...
        link.append('http://103.96.106.250:5000/facebook_posts/download/' +file)
        print('http://103.96.106.250:5000/facebook_posts/download/' +file)
...
################################################twitter#######################################################
    ...
    for file in filtered_lst:
        ...
        link.append('http://103.96.106.250:5000/twitter/download/' +file)
        print('http://103.96.106.250:5000/twitter/download/' +file)
...
#For twitter
    ...
    for file in filtered_lst:
        ...
        link.append('http://103.96.106.250:5000/google/download/' +file)
        print('http://103.96.106.250:5000/google/download/' +file)
...
################################################YouTube#######################################################
    ...
    for file in filtered_lst:
        ...
        link.append('http://103.96.106.250:5000/youtube/download/' +file)
        print('http://103.96.106.250:5000/youtube/download/' +file)
...
def facbook_download(request):
    ...
    print(filtered_lst)
    for file in filtered_lst:
        link ='http://103.96.106.250:5000/facebook_posts/download/' +file
